	...
	public function index() {
      ...
      $this->request->post['config_address'] = $this->request->post['config_langdata'][$front_language_id]['comment'];
		...
		/*additional-phones*/
					...
					if (isset($this->request->post['config_telephone5'])) {
						$data['config_telephone5'] = $this->request->post['config_telephone5'];
					} else {
						$data['config_telephone5'] = $this->config->get('config_telephone5');
					}
					if (isset($this->request->post['config_telephone6'])) {
						$data['config_telephone6'] = $this->request->post['config_telephone6'];
					} else {
						$data['config_telephone6'] = $this->config->get('config_telephone6');
					}
					if (isset($this->request->post['config_telephone7'])) {
						$data['config_telephone7'] = $this->request->post['config_telephone7'];
					} else {
						$data['config_telephone7'] = $this->config->get('config_telephone7');
					}
					if (isset($this->request->post['config_telephone8'])) {
						$data['config_telephone8'] = $this->request->post['config_telephone8'];
					} else {
						$data['config_telephone8'] = $this->config->get('config_telephone8');
					}
					if (isset($this->request->post['config_telephone9'])) {
						$data['config_telephone9'] = $this->request->post['config_telephone9'];
					} else {
						$data['config_telephone9'] = $this->config->get('config_telephone9');
					}
					if (isset($this->request->post['config_telephone10'])) {
						$data['config_telephone10'] = $this->request->post['config_telephone10'];
					} else {
						$data['config_telephone10'] = $this->config->get('config_telephone10');
					}
					/*additional-phones*/
