        ...
        <form action="<?php echo $action; ?>" method="post" enctype="multipart/form-data" id="form-setting" class="form-horizontal">
          ...
          <div class="tab-content">
            ...
            <div class="tab-pane" id="tab-store">
                ...
                <div class="form-group required">
                  <?php echo $entry_image_contact; ?>
                  <div class="col-sm-10">
                    <input type="text" name="config_image_from" value="<?php echo $config_image_from; ?>" />
                ...
                <div class="form-group required">
                  ...
                  <div class="col-sm-10">
                	...
                	<!--additional-phones-->
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone2"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone3"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
					...
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone4"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone4" value="<?php echo $config_telephone4; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone4" class="form-control" />
	                  </div>
	                </div>


					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone5"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone5" value="<?php echo $config_telephone5; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone5" class="form-control" />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone6"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone6" value="<?php echo $config_telephone6; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone6" class="form-control" />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone7"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone7" value="<?php echo $config_telephone7; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone7" class="form-control" />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone8"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone8" value="<?php echo $config_telephone8; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone8" class="form-control" />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone9"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone9" value="<?php echo $config_telephone9; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone9" class="form-control" />
	                  </div>
	                </div>
					<div class="form-group">
	                  <label class="col-sm-2 control-label" for="input-telephone10"><?php echo $entry_telephone; ?></label>
	                  <div class="col-sm-10">
	                    <input type="text" name="config_telephone10" value="<?php echo $config_telephone10; ?>" placeholder="<?php echo $entry_telephone; ?>" id="input-telephone10" class="form-control" />
	                  </div>
	                </div>
					<!--additional-phones-->
