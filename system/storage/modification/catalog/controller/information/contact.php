...
class ControllerInformationContact extends Controller {
	...
	public function index() {
		...
		$data['telephone'] = $this->config->get('config_telephone');
					...
					$data['telephone5'] = $this->config->get('config_telephone5');
					$data['telephone6'] = $this->config->get('config_telephone6');
					$data['telephone7'] = $this->config->get('config_telephone7');
					$data['telephone8'] = $this->config->get('config_telephone8');
					$data['telephone9'] = $this->config->get('config_telephone9');
					$data['telephone10'] = $this->config->get('config_telephone10');
					/*additional-phones*/
